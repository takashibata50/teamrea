...
$to = "info5@job-commit.com,y-futagawa@job-commit.com,n-koshimura@reastage.co.jp,t-shibata@reastage.co.jp,r-komiya@reastage.co.jp";
//$from = "okada@power-cast.co.jp";
...
$subject = "就活市場21からジョブチャレにエントリーがありました";
...
$thanksPage = "https://job-commit.com/employ/thanks/";
...
$refrom_name = "就活市場運営事務局";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "イベントにお申し込みありがとうございました";
...
この度はジョブチャレからお申込み頂きまして誠にありがとうございました。

お電話かメールにて担当者からご連絡させていただきますのでお待ち下さい。

当日は、欠席や日程変更・遅刻がないようご調整いただければと存じます。

万が一変更・キャンセルされる場合は、前日までにメールまたはお電話にてご連絡くださいませ。
...
一週間以上経っても、ご連絡メールが届かない場合はお手数ですが以下連絡先にご連絡ください。

ーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー
株式会社リアステージ
所在地　東京都千代田区三番町3番地8 泉館三番町5階
お問い合わせ： 03-4563-6350
Eメールアドレス： info1@job-commit.com
...
<meta name="keywords" content="ハトのマークの引越センター">
<meta name="description" content="ハトのマークの引越センター">
<title>ハトのマークの引越センター</title>
<link rel="stylesheet" href="https://fonts.googleapis.com/earlyaccess/notosansjp.css">
<link rel="stylesheet" type="text/css" href="css/style.css">
</head>
<body>
<header>
	<div class="logo"> <a href="http://www.hato.or.jp" target="_blank"><img src="img/logo.png" alt="ハトのマークの引越センター"></a></div>
	<div class="contact">
		<div class="txt">お電話での<br class="pc">お問い合わせ・お見積り</div>
		<div class="tel"><a href="tel:0120-191900">0120-191900</a><small>受付時間 9:00-18:00 [年中無休/年末年始除く]</small></div>
	</div>
</header>
...
<footer>Copyright (C)2018 National Federation Of Moving <br class="sp">Co-Operative Association All Rights Reserved.</footer>
</body>
</html>
<?php
